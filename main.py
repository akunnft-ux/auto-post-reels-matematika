...
def render_video(narasi, topic, filename):
    ...
    try:
        ...
        clip1 = ImageClip(frame1, duration=8).crossfadein(1).crossfadeout(1)
        clip2 = ImageClip(frame2, duration=8).crossfadein(1).crossfadeout(1)
        clip3 = ImageClip(frame3, duration=10).crossfadein(1).crossfadeout(1)
